...
public class SetupAccountPage {
    ...
    public void show(Stage primaryStage) {
        ...
        titleLabel.setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-padding: 10; -fx-text-fill: white;");
        
        Label instructionLabel = new Label("Fill in the details below to set up your account:");
        instructionLabel.setStyle("-fx-font-size: 14px; -fx-padding: 5; -fx-text-fill: white;");
        ...
        setupButton.setStyle("-fx-font-size: 14px; -fx-padding: 10 20; -fx-background-color: #6c63ff; -fx-text-fill: white;");
        ...
        backButton.setStyle("-fx-font-size: 12px; -fx-padding: 8 15; -fx-background-color: #3c3f41; -fx-text-fill: white;");
        backButton.setOnAction(e -> new SetupLoginSelectionPage(databaseHelper).show(primaryStage));

        // Layout
        VBox layout = new VBox(12);
        layout.setStyle("-fx-padding: 20; -fx-alignment: center; -fx-background-color: #1e1e1e;");
