...
public class SetupLoginSelectionPage {
    ...
    public void show(Stage primaryStage) {
        ...
        // Button Styling
        setupButton.setStyle("-fx-font-size: 14px; -fx-padding: 8px 20px; -fx-background-color: #6c63ff; -fx-text-fill: white;");
        loginButton.setStyle("-fx-font-size: 14px; -fx-padding: 8px 20px; -fx-background-color: #3c3f41; -fx-text-fill: white;");	
        ...
        layout.setStyle("-fx-padding: 40px; -fx-background-color: #1e1e1e;");
