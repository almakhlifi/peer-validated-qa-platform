...
public class AdminHomePage {
    ...
    public void show(Stage primaryStage, DatabaseHelper databaseHelper, User user) {
        ...
        layout.setStyle("-fx-padding: 25; -fx-alignment: center; -fx-background-color: #1e1e1e;");

        // Admin greeting label
        Label adminLabel = new Label("Admin Dashboard");
        adminLabel.setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-padding: 10; -fx-text-fill: white;");
        ...
        roleLabel.setStyle("-fx-font-weight: bold; -fx-padding: 5; -fx-text-fill: white;");
        ...
        // Button styling
        addRoleButton.setStyle("-fx-background-color: #3c3f41; -fx-text-fill: white;");
        removeRoleButton.setStyle("-fx-background-color: #3c3f41; -fx-text-fill: white;");
        ...
        otpLabel.setStyle("-fx-font-weight: bold; -fx-padding: 5; -fx-text-fill: white;");
        ...
        setOneTimePasswordButton.setStyle("-fx-background-color: #6c63ff; -fx-text-fill: white;");
        ...
        inviteBox.setStyle("-fx-background-color: #3c3f41; -fx-text-fill: white;");
        ...
        adminScene.getStylesheets().add(getClass().getResource("dark-theme.css").toExternalForm());
