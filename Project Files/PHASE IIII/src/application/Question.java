...
public class Question {
    ...
    /**
     * Returns the ID of the accepted answer, or null if none has been accepted.
     * @return The accepted answer ID or null.
     */
    ...
    /**
     * Sets the ID of the accepted answer for this question.
     * @param acceptedAnswerId The answer ID to set as accepted.
     */
    ...
    /**
     * Determines whether the question has an accepted answer.
     * @return True if the question has an accepted answer; false otherwise.
     */
